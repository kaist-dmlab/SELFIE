...
We compared **SELFIE** with two state-of-the-art robust training methods. We also provide the links of official/unofficial implementations for each method (The two algorithms are included in our source).
