...
```
```python
# you can read this bianry file as below: (Similar to read CIFAR-10 in the popular [tutorial](https://github.com/tensorflow/models/blob/master/tutorials/image/cifar10/cifar10_input.py)) 
ID_BYTES = 4
LABEL_BYTES = 4
