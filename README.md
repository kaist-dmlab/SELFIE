...
## **2019 09 05: Bug Report** 
**After fixing some code, it has been reported that the performance of SELFIE based on uploaded code is slightly differnt to that in our paper. For the performance, please use the previous version of code "src_190121.zip" at [HERE](SELFIE).**
