...
```
## 4. Noise Injection
Except ANIMAL-10N dataset, since all data sets are clean, we artifically corrupted CIFAR-10, CIFAR-100 and Tiny-ImageNet datasets using a typical method: flipping the true label *i* to the corrupted label *j*.
- *Pair flipping (noise)*
- *Symmetry flipping (noise)* 
